      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link href="/dashboard/wallet" className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl transition-all shadow-lg shadow-blue-500/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 border border-blue-500/20 shadow-2xl shadow-blue-500/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link href="/dashboard/wallet" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-all">
              Create Now
